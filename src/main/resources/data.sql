-- groupe
insert into groupe(nom)values('equipe-A');
insert into groupe(nom)values('equipe-B');

-- perso
insert into personne(nom, prenom, pseudo, age, email) values ('Amianto', 'Sylvain',  'cql'      ,34, 'samianto@cqlTeam.go');
insert into personne(nom, prenom, pseudo, age, email) values ('Cinelli' ,'jeremy',   'Lombre'   ,31, 'ert@cqlTeam.go');
